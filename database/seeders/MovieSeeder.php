...
class MovieSeeder extends Seeder
{
    ...
    {
        // Get all cities to create relationships
        $cities = City::all();
        ...
        foreach ($movies as $movieData) {
            // Extract city IDs for relationship
...
//            $cityIds = $cityIndices ? $cities->whereIn('id', function($key) use ($cities, $cityIndices) {
//                return in_array($key, $cityIndices);
//            })->pluck('id')->toArray() : [];
            $cityIds = [];
            foreach ($cityIndices as $index) {
                // Get city at the specified index, if it exists
            ...
            if (!empty($cityIds)) {
                // Create movie-city relationships in pivot table
